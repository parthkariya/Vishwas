        ...
        <div className="pro_det_sunflower">
          <div className="product_head">
            <h1 style={{ fontSize: "30px" }}>
              Manufacturer of <br /> Filtered Mustard Oil Kachi Ghani
            </h1>
          </div>
          <div style={{ textAlign: "justify", lineHeight: "" }}>
            <p>
              Experience the rich, robust flavor of our Mustard Oil Kachi Ghani,
              a premium cold-pressed oil made from the finest mustard seeds.
              Traditionally extracted using the Kachi Ghani method, this oil
              preserves the natural nutrients and distinctive aroma, ensuring
              that every drop is packed with flavor and health benefits. Rich in
              omega-3 and omega-6 fatty acids, our mustard oil is not only a
              cooking staple but also a versatile ingredient for marinades,
              dressings, and frying. Its unique pungency enhances the taste of
              your dishes, making it ideal for regional Indian cuisines and
              beyond. In addition to its culinary uses, Mustard Oil Kachi Ghani
              is celebrated for its skin and hair benefits, making it a favorite
              in natural beauty routines. Whether you’re sautéing vegetables,
              making pickles, or nourishing your skin, our mustard oil is the
              perfect addition to your kitchen and beauty arsenal.
            </p>{" "}
          </div>
          <div>
            ...
            <div className="icons_main">
              ...
              <div>
                ...
                <div>
                  {/* <h5 style={{ margin: "4px", textAlign: "center" }}>500ML</h5> */}
                  <h5 style={{ margin: "4px", textAlign: "center" }}>1 L</h5>
                  <h5 style={{ margin: "4px", textAlign: "center" }}>170 G</h5>
                  <h5 style={{ margin: "4px", textAlign: "center" }}>425 G</h5>
                  <h5 style={{ margin: "4px", textAlign: "center" }}>850 G</h5>
                  <h5 style={{ margin: "4px", textAlign: "center" }}>1.7 KG</h5>
                </div>
              </div>
              <div>
                <div>
                ...
                <div>
                  ...
                  <h5 style={{ margin: "4px", textAlign: "center" }}>4.2 KG</h5>
                </div>
              </div>
              <div>
                {/* <div>
