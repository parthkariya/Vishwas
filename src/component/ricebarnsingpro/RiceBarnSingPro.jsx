      ...
      <div className="product_main">
        ...
        <div className="pro_det_sunflower">
          ...
          <div style={{ textAlign: "justify", lineHeight: "" }}>
            <p>
              Refined Rice Bran Oil is extracted from the outer layer (bran) of
              rice and undergoes a purification process to remove impurities
              while retaining essential nutrients like Oryzanol, Vitamin E, and
              healthy fats. It is a heart-healthy oil that helps lower bad
              cholesterol (LDL) and increase good cholesterol (HDL), making it
              ideal for daily cooking. With a high smoke point (~232°C), it is
              perfect for deep frying, stir-frying, and Indian cooking, as it
              absorbs less oil, keeping food light and healthy. Rich in
              antioxidants, it boosts immunity, supports skin and hair health,
              and aids digestion. The oil contains approximately 45% MUFA, 35%
              PUFA, and 20% saturated fats, along with 1000+ mg of Oryzanol and
              4-6 mg of Vitamin E per 100ml, making it a balanced choice for a
              healthy lifestyle. Additionally, it is widely used in salad
              dressings, skincare, and pharmaceutical applications.
            </p>{" "}
          </div>
          <div>
