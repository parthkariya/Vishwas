        ...
        <div className="pro_det_sunflower">
          <div className="product_head">
            <h1 style={{ fontSize: "30px" }}>
              Manufacturer of <br /> Filtered Mild Mustard Oil
            </h1>
          </div>
          <div style={{ textAlign: "justify", lineHeight: "" }}>
            <p>
              Mild mustard oil is a versatile cooking oil extracted from mustard
              seeds, known for its gentle, nutty flavor that enhances a variety
              of dishes without being overpowering. Characterized by its light
              yellow to golden hue, this oil is particularly popular in Indian
              and Bangladeshi cuisines, where it is used for sautéing, frying,
              and as a base for marinades and dressings. Rich in omega-3 and
              omega-6 fatty acids, mild mustard oil not only contributes to
              heart health but also possesses natural antimicrobial properties,
              making it beneficial for food preservation. Its subtle aroma and
              unique taste make it an essential ingredient in many traditional
              recipes, while its nutritional profile offers a healthy
              alternative to more common cooking oils.
            </p>{" "}
          </div>
          <div>
